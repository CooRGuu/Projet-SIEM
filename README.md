...
1. VirtualBox + logique “labo” : inacceptable pour de la prod école (pas de HA sérieuse, limites réseau/stockage, maintenance fragile). Base attendue : hyperviseur entreprise (Proxmox/ESXi), segmentation réseau et plan de reprise.
...
- CPU (modèle + cœurs),
- RAM,
- stockage (type, capacité, IOPS mesurées),
